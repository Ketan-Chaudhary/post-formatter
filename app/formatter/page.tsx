...
export default function FormatterPage() {
  ...
  const applyStyle = useCallback(
    async (style: StyleType) => {
      ...
      try {
        ...
        const beforeSelection = currentContent.substring(
          0,
  ...
  const exportAsJSON = useCallback(() => {
    ...
    toast({
      ...
      description: "Your post has been exported as a JSON file.",
    });
  }, [charCount, toast]);
      ...
      if (e.ctrlKey || e.metaKey) {
        switch (e.key.toLowerCase()) {
          ...
          case "s":
            ...
            toast({
              title: "Draft Saved",
              description: "Your post has been saved locally.",
            });
            break;
        }
      }
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        !target.closest("[data-bullet-selector]") &&
        !target.closest("[data-bullet-button]")
      ) {
        setShowBulletSelector(false);
      }
    };
      ...
      <div className="container mx-auto p-4 max-w-7xl">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Format your posts with Unicode styling
                  {lastSaved && (
        ...
        <Alert className="mb-6 border-amber-200 bg-amber-50 dark:bg-amber-900/20 dark:border-amber-800">
          ...
          <AlertDescription className="text-amber-800 dark:text-amber-200">
            <strong>Important:</strong> Styled Unicode text may not be
            searchable on LinkedIn and might not be interpreted correctly by
            screen readers. Use sparingly for accessibility.
          </AlertDescription>
        </Alert>
            ...
            <CardContent className="p-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800 dark:text-blue-200">
                      <strong>Select any text</strong> in the editor below and
                      formatting options will appear above your selection. You
                      can apply <strong>bold</strong>, <em>italic</em>, or{" "}
                      <strong>
                        <em>combined</em>
                      </strong>{" "}
                      styling.
              ...
              <div className="relative">
                <div
                  ...
                  placeholder="Write your LinkedIn post here... Select text to format it with bold, italic, or combined styling."
                  spellCheck="true"
                />
                ...
                {!content && (
                  <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                    <div className="text-center text-gray-400 dark:text-gray-500 max-w-md">
                      ...
                      <p className="text-sm">Start typing your post...</p>
                      <p className="text-xs mt-1">
                        Select any text to see formatting options
                      </p>
                    </div>
                  </div>
                )}
              ...
              {isOverLimit && (
                <Alert className="mt-4" variant="destructive">
                  ...
                  <AlertDescription>
                    Your post exceeds LinkedIn's {LINKEDIN_CHAR_LIMIT} character
                    limit by {charCount - LINKEDIN_CHAR_LIMIT} characters.
                  </AlertDescription>
                </Alert>
              )}
            ...
            <CardContent className="p-6">
              <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-xl p-6 min-h-[300px] transition-colors duration-200">
                ...
                <div className="text-gray-900 dark:text-white whitespace-pre-wrap leading-relaxed">
                  {previewContent || "Your formatted post will appear here..."}
                </div>
